...
if __name__ == "__main__":
    model = load_moco_resnet_embedding(
        "/mnt/nas7/data/Personal/Darya/Checkpoints/superpixel_cluster_clean/"
        "no_cluster_4MLP_queue32768_resnet101_beta0.005_epochs100_moco_superpixel/"
        "best_model_epoch94.pth",
        device="cuda",
    ...
    with torch.no_grad():
        ...
        print(h.norm(dim=1).mean().item())  # just to see it's finite & sane
