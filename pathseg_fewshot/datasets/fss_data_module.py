...
from pathseg_fewshot.datasets.fss_dataset import (
    Dataset,
    PredictDataset,
...
class FSSDataModule(LightningDataModule):
    def __init__(
        ...
        root_dir = Path(root)
        rank_zero_info(f"[FSSDataModule] Initializing datamodule with split = {self.fold}")
        rank_zero_info(
